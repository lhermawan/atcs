            ...
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center gap-6">
                    ...
                    <nav class="hidden md:flex items-center gap-1 ml-4 bg-slate-100 dark:bg-slate-800/50 p-1 rounded-lg border border-slate-200 dark:border-slate-700">
                        ...
                        <a href="{{ route('analytics.index') }}" class="px-4 py-1.5 rounded-md text-sm font-semibold transition-colors {{ request()->routeIs('analytics.index') ? 'bg-white dark:bg-slate-700 text-indigo-600 dark:text-indigo-400 shadow-sm' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 hover:bg-slate-200/50 dark:hover:bg-slate-700/50' }}">
